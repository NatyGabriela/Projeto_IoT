<div>
    ...
    <div class="col-md-6 mx-auto">
        <div class="card bg-primary-subtle " >
            <h5 class="card-header fw-bold text-center" $font-family="sans-serif">Cadastro de Sensor</h5>
            <div class="card-body">
                <form wire:submit.prevent="store">
                    <div class="mb-3">
                        <label for="codigo" class="form-label fw-bold text-center">CÓDIGO</label>
                        <input type="text" class="form-control" id="codigo" name="codigo"
                            placeholder="ex:codigo" wire:model.defer="codigo">
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group ">
                            <select class="form-select" aria-label="Default select example" wire:model.defer="tipo">
                                ...
                                <option value="1">Sensores de Presença</option>
